...
public interface KieService {
    ...
    void setProcessVariablesAsJson(String containerId, Long processInstanceId, Object value);
    ...
    List<MagfaProcessDefinition> processDefinitions(String containerId, User user);
    ...
    List<MagfaTaskInstance> assignedTasks(User user, Integer page, Integer pageSize);
